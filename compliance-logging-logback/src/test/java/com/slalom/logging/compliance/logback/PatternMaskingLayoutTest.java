...
public class PatternMaskingLayoutTest {
    ...
    public void testMaskJsonMessage() {
        ...
        // then
        assertThat(actual).contains("my message with json {\"login\":\"john\",\"password\":\"***********\",\"ssn\":\"***********\"}");
    }
    ...
    public void testMaskLombokMessage() {
        // given
        String fields = "password,ssn";
        String message = "my message with lombok " + Employee.builder().firstName("john").lastName("doe").password("mypassword").ssn("123-12-1234").build();
        PatternMaskingLayout layout = buildLayout(fields);
        ...
        // then
        assertThat(actual).contains("my message with lombok Employee(firstName=john, lastName=doe, password=***********, ssn=***********)");
    }
